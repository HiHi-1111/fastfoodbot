"""
train_efficientnetv2_s.py

Same as train_convnext_tiny.py but trains EfficientNetV2 S.

Example:
python train_efficientnetv2_s.py --dataset_root "path/to/your/dataset"
"""
...
def main():
    ...
    run_name = f"efficientnetv2_s_{int(time.time())}"
